...
`r knitr::include_graphics("gallery/figures/map.png")`

[Facet Map](https://github.com/kylebutts/kfbmisc/blob/master/gallery/map.R)
`r knitr::include_graphics("gallery/figures/facet_map.png")`
